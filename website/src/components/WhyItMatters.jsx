      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="reveal opacity-0 delay-200 text-text-secondary text-lg leading-relaxed mb-10">
            ...
            {/* Bullet List */}
            <div className="reveal opacity-0 delay-300 grid grid-cols-2 gap-4">
              {bullets.map((item, i) => (
